...
#[bench]
fn new_ordermap(b: &mut Bencher) {
    b.iter(|| OrderMap::<String, String>::new());
}
...
#[bench]
fn with_capacity_10e5_ordermap(b: &mut Bencher) {
    b.iter(|| OrderMap::<String, String>::with_capacity(10_000));
}
...
#[bench]
fn insert_ordermap_10_000(b: &mut Bencher) {
    let c = 10_000;
    b.iter(|| {
...
#[bench]
fn insert_ordermap_string_10_000(b: &mut Bencher) {
    let c = 10_000;
    b.iter(|| {
        let mut map = OrderMap::with_capacity(c);
        for x in 0..c {
...
#[bench]
fn insert_ordermap_str_10_000(b: &mut Bencher) {
    let c = 10_000;
    let ss = Vec::from_iter((0..c).map(|x| x.to_string()));
    b.iter(|| {
        let mut map = OrderMap::with_capacity(c);
...
#[bench]
fn insert_ordermap_int_bigvalue_10_000(b: &mut Bencher) {
    let c = 10_000;
    let value = [0u64; 10];
    b.iter(|| {
        let mut map = OrderMap::with_capacity(c);
...
#[bench]
fn insert_ordermap_100_000(b: &mut Bencher) {
    let c = 100_000;
    b.iter(|| {
        let mut map = OrderMap::with_capacity(c);
        for x in 0..c {
...
#[bench]
fn insert_ordermap_150(b: &mut Bencher) {
    let c = 150;
    b.iter(|| {
        let mut map = OrderMap::with_capacity(c);
        for x in 0..c {
...
#[bench]
fn entry_ordermap_150(b: &mut Bencher) {
    let c = 150;
    b.iter(|| {
        let mut map = OrderMap::with_capacity(c);
        for x in 0..c {
...
#[bench]
fn iter_sum_ordermap_10_000(b: &mut Bencher) {
    let c = 10_000;
    let mut map = OrderMap::with_capacity(c);
    let len = c - c / 10;
    for x in 0..len {
...
#[bench]
fn iter_black_box_ordermap_10_000(b: &mut Bencher) {
    let c = 10_000;
    let mut map = OrderMap::with_capacity(c);
    let len = c - c / 10;
    for x in 0..len {
...
#[bench]
fn lookup_ordermap_10_000_exist(b: &mut Bencher) {
    let c = 10_000;
    let mut map = OrderMap::with_capacity(c);
    let keys = shuffled_keys(0..c);
    for &key in &keys {
...
#[bench]
fn lookup_ordermap_10_000_noexist(b: &mut Bencher) {
    let c = 10_000;
    let mut map = OrderMap::with_capacity(c);
    let keys = shuffled_keys(0..c);
    for &key in &keys {
...
#[bench]
fn remove_ordermap_100_000_few(b: &mut Bencher) {
    let map = IMAP_100K.clone();
    let mut keys = Vec::from_iter(map.keys().copied());
    let mut rng = small_rng();
    keys.shuffle(&mut rng);
...
#[bench]
fn remove_ordermap_2_000_full(b: &mut Bencher) {
    let mut keys = KEYS[..2_000].to_vec();
    let mut map = OrderMap::with_capacity(keys.len());
    for &key in &keys {
        map.insert(key, key);
    }
    let mut rng = small_rng();
